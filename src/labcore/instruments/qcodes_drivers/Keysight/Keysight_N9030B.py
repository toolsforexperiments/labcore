# modify based on the qcodes driver for Keysight N9030B spectrum analyzer
"""
A driver to control the Keysight N9030B spectrum analyzer using pyVISA and qcodes

@author: Pfafflab (UIUC): Xi Cao, Michael Mollenhauer
...
class KeysightN9030BSpectrumAnalyzerModeMarkers(InstrumentChannel):
    """
