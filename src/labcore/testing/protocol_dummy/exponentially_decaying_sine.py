...
class ExponentiallyDecayingSineOperation(ProtocolOperation):
    ...
    def __init__(self, params=None):
        ...
        self._register_inputs(
            offset=ExponentiallyDecayingSineOffset(None),
            frequency=ExponentiallyDecayingSineFrequency(None),
            phase=ExponentiallyDecayingSinePhase(None),
            tau=ExponentiallyDecayingSineTau(None),
        )
        self._register_outputs(amplitude=ExponentiallyDecayingSineAmplitude(None))
    ...
    def _measure_dummy(self) -> Path:
        ...
        def measure_exp_decay_sine(x_val):
